...
class AppiumLauncher {
  constructor(options, capabilities, config) {
    ...
    if (!this.command) {
      this.command = 'node';
      this.appiumArgs.push((0, _utils.getAppiumCommand)());
    }
  }

  async onPrepare() {
    const isWindows = process.platform === 'win32';
    this.appiumArgs.push(...(0, _utils.cliArgsFromKeyValue)(this.args));
  ...
  _redirectLogStream(logPath) {
    const logFile = (0, _utils.getFilePath)(logPath, DEFAULT_LOG_FILENAME);
